...
# Conjunto de Dados http://dlib.net/files/data/ibug_300W_large_face_landmark_dataset.tar.gz
...
# divide o conjunto de dados em conjuntos de validação e teste

len_valid_set = int(0.1*len(dataset))
len_train_set = len(dataset) - len_valid_set
train_dataset , valid_dataset,  = torch.utils.data.random_split(dataset , [len_train_set, len_valid_set])

# embaralhar e agrupar os conjuntos de dados
...
for epoch in range(1,num_epochs+1):
    ...
    for step in range(1,len(train_loader)+1):
        ...
        # limpe todos os gradientes antes de calculá-los

        optimizer.zero_grad()
        
        # encontre a perda para a etapa atual
